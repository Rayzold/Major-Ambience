...
> Numbering note: this is a mobile-only release (bumps `apps/mobile/package.json` 0.0.9 → 0.0.10; desktop version files untouched). The unified `0.0.25` assumes desktop PRs #24 (0.0.23) and #25 (0.0.24) land first — renumber on rebase if they don't.
