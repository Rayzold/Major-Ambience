// Custom SVG glyphs for the Music Companion app.
// All glyphs render at the size given, monochrome (currentColor).
// Style: 1.5px stroke, slightly hand‑drawn, RPG‑codex feel.

function Glyph({ name, size = 24, stroke = 1.6, style = {} }) {
  ...
  switch (name) {
    ...
    case 'pause':
      return <svg viewBox="0 0 24 24" style={s}><rect x="6" y="4" width="4" height="16" rx="1" fill="currentColor"/><rect x="14" y="4" width="4" height="16" rx="1" fill="currentColor"/></svg>;
    case 'prev':
    ...
    case 'duck':
      return <svg viewBox="0 0 24 24" style={s}><path d="M11 5a3 3 0 0 0-3 3v2H6a3 3 0 0 0 0 6h2l1 4h6l1-4h2a4 4 0 0 0 0-8h-1c-1-3-3-3-6-3z" {...p}/><circle cx="13" cy="8" r="0.5" fill="currentColor"/></svg>;
    case 'mute':
    ...
    case 'scenes':
      return <svg viewBox="0 0 24 24" style={s}><rect x="3" y="5" width="18" height="14" rx="2" {...p}/><path d="M3 9h18 M7 5v-1 M11 5v-1 M15 5v-1 M19 5v-1" {...p}/></svg>;
    case 'soundboard':
      return <svg viewBox="0 0 24 24" style={s}><rect x="3" y="3" width="8" height="8" rx="1.5" {...p}/><rect x="13" y="3" width="8" height="8" rx="1.5" {...p}/><rect x="3" y="13" width="8" height="8" rx="1.5" {...p}/><rect x="13" y="13" width="8" height="8" rx="1.5" {...p}/></svg>;
    case 'sliders':
      return <svg viewBox="0 0 24 24" style={s}><path d="M4 6h10 M18 6h2 M4 12h2 M10 12h10 M4 18h14 M18 18h2" {...p}/><circle cx="16" cy="6" r="2" {...p}/><circle cx="8" cy="12" r="2" {...p}/><circle cx="16" cy="18" r="2" {...p}/></svg>;
    case 'plus':
    ...
    case 'note':
      return <svg viewBox="0 0 24 24" style={s}><path d="M5 4h10l4 4v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1z M15 4v4h4 M8 12h7 M8 16h7" {...p}/></svg>;
    case 'star':
    ...
    case 'settings':
      return <svg viewBox="0 0 24 24" style={s}><circle cx="12" cy="12" r="3" {...p}/><path d="M12 2v3 M12 19v3 M2 12h3 M19 12h3 M5 5l2 2 M17 17l2 2 M19 5l-2 2 M5 19l2-2" {...p}/></svg>;
    default:
